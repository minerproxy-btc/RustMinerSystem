...
```
   4.1.2
   鉴于4.0.0-4.1.1版本出现重大BUG，故删除对应版本，请4.0.0-4.1.1尽快更新至最新版本！
   增加矿池节点模式，现在可以在-菜单-矿池节点 中使设备成为矿池节点

   3.9.94
   所有币种全部应用3.9.92的抗网络波动方式；
   整体稳定性大幅提升

   3.9.93
   修复3.9.92 KAS＞6.5T端口无法正常工作的问题；
   修复部分小币种特殊机型设置比例分配不足的问题

   3.9.92
   彻底解决网络波动导致的BTC小部分矿机掉线/死机问题；
   端口配置增加了替换矿工名
